...
$sql = "INSERT INTO `fitness`(`id`, `image`) VALUES ('$busid','$file')";
...
<body>
    ...
    <header>
        <marquee direction="left"  scrollamount= "20" class="marq"><img src="bus.jpg" id="img3"/> FITNESS CERTIFICATE <img src="bus.jpg" id="img3"/></marquee>
    </header>
    <main>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" id="btn2" name="fitnessfile" value="Uplaod">
        </form>
        <section>
            <?php
            ...
            $image_path = "fitnessimage/".$image_name;
