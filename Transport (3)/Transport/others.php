...
$desc=$_POST['desc'];
$cost=$_POST['cost'];
$sql = "INSERT INTO `others` VALUES ('$busid','$cate','$date','$desc','$cost')";
...
<marquee class="mar"> <img src="bus.jpg" class="img3"/>SOCIAL EDUCATION TRUST <img src="bus.jpg" class="img3"/></marquee><br>
<p for="heading" class="p1">Engine Repairs</p>
